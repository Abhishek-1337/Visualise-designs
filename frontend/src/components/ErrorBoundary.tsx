        ...
        <div className="min-h-screen flex items-center justify-center bg-background">
          <div className="text-center p-8 max-w-md">
            ...
            <div className="flex flex-col gap-1 text-center">
              ...
              <p className="text-muted-foreground text-base w-8/12 mx-auto">We encountered an unexpected error while processing your request.</p>
            </div>
            <div className="flex justify-center items-center mt-6">
              <button
                ...
                className="bg-primary text-primary-foreground font-medium py-2 px-4 rounded-lg flex items-center gap-2 transition-smooth hover:opacity-90 shadow-warm-sm"
              >
                <Icon name="ArrowLeft" size={18} color="var(--color-primary-foreground)" />
                Back
              </button>
            </div>
          </div >
