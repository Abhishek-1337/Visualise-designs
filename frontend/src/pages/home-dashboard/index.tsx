  ...
  return (
    <div className="bg-card rounded-xl shadow-warm-md p-4 md:p-6 transition-smooth hover-lift">
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <Link to="/settings-configuration" className="flex flex-col items-center gap-2 p-4 rounded-lg border border-border bg-background hover:border-primary/30 hover:shadow-warm-sm transition-smooth">
          <Icon name="Users" size={24} color="var(--color-primary)" />
          <span className="text-sm font-medium text-foreground">Manage Team</span>
        </Link>
        <Link to="/settings-configuration?tab=security" className="flex flex-col items-center gap-2 p-4 rounded-lg border border-border bg-background hover:border-primary/30 hover:shadow-warm-sm transition-smooth">
          <Icon name="Shield" size={24} color="var(--color-primary)" />
          <span className="text-sm font-medium text-foreground">Security</span>
        </Link>
        <Link to="/settings-configuration?tab=automation" className="flex flex-col items-center gap-2 p-4 rounded-lg border border-border bg-background hover:border-primary/30 hover:shadow-warm-sm transition-smooth">
          <Icon name="Zap" size={24} color="var(--color-primary)" />
          <span className="text-sm font-medium text-foreground">Automation</span>
        </Link>
        <Link to="/settings-configuration?tab=integrations" className="flex flex-col items-center gap-2 p-4 rounded-lg border border-border bg-background hover:border-primary/30 hover:shadow-warm-sm transition-smooth">
          <Icon name="Plug" size={24} color="var(--color-primary)" />
